  ...
  return (
    <>
      <div className="ui container" id="formNameID">
        ...
        {inputVal.departName === "IT" ? departmentObj.IT : inputVal.departName === "Accounts" ? departmentObj.Accounts : inputVal.departName === "Logistics" ? departmentObj.Logistics : inputVal.departName === "Collection" ? departmentObj.Collection : inputVal.departName === "Marcom" ? departmentObj.Marcom : inputVal.departName === "HR" ? departmentObj.HR : inputVal.departName === "FMS" ? departmentObj.FMS : ""}
          ...
          <div className="container mt-5">
            ...
            <div className="row mb-5">
              <button type="reset" className="btn btn-danger col-12" onClick={discardFunc}>
                Discard
              </button>
            </div>
          </div>
